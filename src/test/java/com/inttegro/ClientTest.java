...
class ClientTest {
    ...
    void refundsSupportCanonicalLifecycle() throws Exception {
        ...
        RefundProductOrderLineItem lineItem = assertInstanceOf(RefundProductOrderLineItem.class, canonical.lineItems.get(0).orderLineItem);
        assertEquals(2, lineItem.quantity);
        assertEquals("prod_123", lineItem.product.id);
